...
const ComplaintSubmitPrompt = () => {
  return (
    <div className='complaint-submit-prompt'>
      <p>
        Once you hit the <strong>Report It!</strong> button, the FCC form will 
        pull up and your answers will appear. Just remember,
      </p>
      <ol>
        <li>
      ...
      <p>
        ...
        report. Check out the <strong>My Reports</strong> section to view past 
        reports.
      </p>
    </div>
  );
